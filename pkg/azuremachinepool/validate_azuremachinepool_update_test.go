	...
	testCases := []testCase{
		{
			...
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			allowed:      true,
			errorMatcher: nil,
		},
		{
			name:         "case 1: AcceleratedNetworking is disabled in CR and we don't change it or the instance type",
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], &fa, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(supportedInstanceType[0], &fa, compute.StorageAccountTypesStandardLRS),
			allowed:      true,
			errorMatcher: nil,
		},
		{
		...
		},
		{
			...
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(supportedInstanceType[1], &tr, compute.StorageAccountTypesStandardLRS),
			allowed:      true,
			errorMatcher: nil,
		},
		{
			...
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(unsupportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			allowed:      false,
			errorMatcher: IsInvalidOperationError,
		},
		{
		...
		},
		{
			...
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], nil, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			allowed:      false,
			errorMatcher: IsInvalidOperationError,
		},
		{
			...
			oldNodePool:  azureMPRawObject(supportedInstanceType[0], &tr, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(supportedInstanceType[0], nil, compute.StorageAccountTypesStandardLRS),
			allowed:      false,
			errorMatcher: IsInvalidOperationError,
		},
		{
		...
		},
		{
			...
			oldNodePool:  azureMPRawObject(premiumStorageInstanceType, nil, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(standardStorageInstanceType, nil, compute.StorageAccountTypesStandardLRS),
			allowed:      false,
			errorMatcher: IsInvalidOperationError,
		},
		{
			name:         "case 11: changed from standard to premium storage",
			oldNodePool:  azureMPRawObject(standardStorageInstanceType, nil, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(premiumStorageInstanceType, nil, compute.StorageAccountTypesStandardLRS),
			allowed:      true,
			errorMatcher: nil,
		},
		{
			...
			oldNodePool:  azureMPRawObject(standardStorageInstanceType, nil, compute.StorageAccountTypesStandardLRS),
			newNodePool:  azureMPRawObject(premiumStorageInstanceType, nil, compute.StorageAccountTypesPremiumLRS),
			allowed:      false,
			errorMatcher: IsInvalidOperationError,
		},
	}
...
func azureMPRawObject(vmSize string, acceleratedNetworkingEnabled *bool, storageAccountType compute.StorageAccountTypes) []byte {
