...
- Addede mutating webhook to set storage account type in the AzureMachinePool CR if unset.
...
[Unreleased]: https://github.com/giantswarm/azure-admission-controller/compare/v1.6.2...HEAD
